...
cap = cv2.VideoCapture('danngechuresources/videos/parking_slots.mp4')
width, height = 103, 43
with open('dan_nparking_slot', 'rb') as f:
...
while True:
    ...
    img = cv2.imread('danngechuresources/photos/car slot.png')
